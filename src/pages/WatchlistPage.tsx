                      ...
                      <div className="flex items-center gap-4 mt-3">
                        ...
                        <button
                          onClick={() => {
                            ...
                            addToast(`Price alert set for ${product.name}!`, 'success');
                          }}
                          className="flex items-center gap-1 px-4 py-2 border border-gray-200 text-sm font-medium text-gray-700 rounded-lg hover:border-indigo-300 hover:bg-indigo-50 transition-colors"
                        >
